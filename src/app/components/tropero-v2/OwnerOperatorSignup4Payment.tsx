...
import {Building2, Wallet, Users, Smartphone} from 'lucide-react';
import { SignupHeader } from './SignupHeader';

interface OwnerOperatorSignup4PaymentProps {
  onNext: () => void;
  onSkip: () => void;
  onBack: () => void;
}
...
export function OwnerOperatorSignup4Payment({ onNext, onSkip, onBack }: OwnerOperatorSignup4PaymentProps) {
    ...
    <div style={{ minHeight: '100vh', backgroundColor: '#F6F1E8' }}>
      ...
      <main className="px-6 py-12">
        <div className="max-w-3xl mx-auto">
          ...
          <h1 className="text-3xl font-bold text-black mb-2">¿Cómo te gustaría cobrar?</h1>
          <p className="text-gray-600 mb-8">
            Configurá cómo querés recibir tus pagos por servicios de transporte
          </p>
