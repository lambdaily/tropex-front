...
interface OwnerOperatorSignup5PayoutMethodProps {
  onNext: () => void;
  onSkip: () => void;
  onBack: () => void;
}

export function OwnerOperatorSignup5PayoutMethod({ onNext, onSkip, onBack }: OwnerOperatorSignup5PayoutMethodProps) {
